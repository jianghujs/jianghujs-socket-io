...
; (function (factory) {
    ...
    editormd.prototype = editormd.fn = {
        ...
        /**
         * 在watch不开启的情况下获取预览窗口的HTML源码
         * Get html from preview container
         *
         * @returns {editormd}         返回editormd的实例对象
         */

        getPreviewedHTML2: function () {
            var settings = this.settings;
            var cm = this.cm;
            var cmValue = cm.getValue();
    ...
    editormd.markdownToHTML = function (id, options) { // Markdown 渲染为 HTML
        var defaults = { // 默认属性
            ...
            previewCodeHighlight: true,
            plugin_path: '/admin/public/editor.md/lib/'
        };
    ...
    editormd.katexURL = {
        css: "/admin/public/editor.md/lib/katex/katex.min",
        js: "/admin/public/editor.md/lib/katex/katex.min",
    };
